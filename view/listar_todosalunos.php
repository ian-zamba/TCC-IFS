...
<div class="panel ">
    <div id="subcab" class="panel-heading">SAMJS - Alunos</div>
...
$sql = "SELECT * FROM aluno,funcionario WHERE  aluno.mat_func = funcionario.mat_func";
...
echo"
         <table class='display bordas' style='width:100%'  id='tabela_aluno'>
         <thead>
         <tr>
            ...
            <th  class='text-center'>Bolsa familia</th>
            <th class='text-center'>Status do aluno</th>
            <th class='text-center'>Data de tranferência</th>
...
if($row['telefone_mae'] != ""){
   ...
   echo"
         <tr>
            ...
            <td class='text-center'> $nascimento1 </td>
            ";
            ...
            <td> $cpf_pai </td>
            <td> $telefone_mae </td>
            <td  class='text-center'> $naturalidade </td>
            <td  class='text-center'> $endereco_aluno </td>
            <td  class='text-center'> $bairro </td>
            <td> $cep </td>
            <td> $cartao_sus </td>
            <td> $bolsa_fam </td>
            <td  class='text-center'> $status_aluno </td>
            <td  class='text-center'> $data_trans </td>
