<form class="form-horizontal " action="src\cadastroturma.php" method="POST">
<fieldset>
<div class="panel ">
...
<div class="form-group">
  ...
  <div class="col-md-8"> 
        <input class="form-control" maxlength="20"  name="nome_turma" type="text" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-3">
  <input class="form-control" id="ano_turma" name="ano_turma" type="text" maxlength="4" required>
  </div>
  ...
  <div class="col-md-8"> 
    ...
    <option selected disabled hidden></option>
    <option value="000">Nenhum</option>
    <?php 
  ...
  echo "<option id='nome_prof' value='$mat_func'>$nome_func</option>";
    }
  }
}
  ...
  <div class="col-md-2">
  <input class="form-control" name="port" type="number" placeholder="Horas" placeholder="Horas" required>
  </div>
  
  <label class="col-md-1 control-label" for="Nome">Geografia<h11>*</h11></label>  
  <div class="col-md-2">
  <input class="form-control"  name="geo" type="number" placeholder="Horas" required>
</div>  

  <label class="col-md-1 control-label" for="Nome">História<h11>*</h11></label>  
  <div class="col-md-2">
  <input class="form-control"  name="his" type="number" placeholder="Horas" required>
</div>  
</div>  
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input class="form-control" name="cie" type="number" placeholder="Horas" required>
  </div>
  
  <label class="col-md-1 control-label" for="Nome">Matemática<h11>*</h11></label>  
  <div class="col-md-2">
  <input class="form-control"  name="mat" type="number" placeholder="Horas" required>
</div>  

  <label class="col-md-1 control-label" for="Nome">Ed. Física<h11>*</h11></label>  
  <div class="col-md-2">
  <input class="form-control"  name="edfis" type="number" placeholder="Horas" required>
</div> 
</div> 
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input class="form-control" name="art" type="number" placeholder="Horas" required>
  </div>
  
  <label class="col-md-1 control-label" for="Nome">Redação<h11>*</h11></label>  
  <div class="col-md-2">
  <input class="form-control"  name="red" type="number" placeholder="Horas" required>
</div>  

  <label class="col-md-1 control-label" for="Nome">Soc. e Cultura<h11>*</h11></label>  
  <div class="col-md-2">
  <input class="form-control"  name="soccul" type="number" placeholder="Horas" required>
</div> 
</div> 
