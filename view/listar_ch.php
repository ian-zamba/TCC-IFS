...
<div class="panel ">
    <div id="subcab" class="panel-heading">SAMJS - Carga Horária
    </div>
...
$sql = "SELECT * FROM `turma` WHERE `cod_turma` = '$turma'";

$result = $conn->query($sql);

echo"
         <table class='display bordas' style='width:100%'  id='tabela_ch'>
         <thead>
         <tr>
            ...
            <th class='text-center'>Redção</th>
