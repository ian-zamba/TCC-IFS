...
AND aluno_turma.cod_turma = turma.cod_turma AND turma.cod_turma = '$turma' AND aluno_turma.avaliacao = '$unidade'";
...
turma.cod_turma = '$turma' AND aluno.mat_aluno = aluno_turma.mat_aluno ";
